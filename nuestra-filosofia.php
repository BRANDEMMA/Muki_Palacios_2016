	...
	<div class="contenido">
		...
		<div class="derecha-contenido">
			<div class="contenedor-nuestra-filosofia">
				...
				<div class="linea-colores"><img class="alto-colores" src="img/linea-colores.jpg"></div>
			</div>
		</div>
	</div>
	<div class="clear"></div>
