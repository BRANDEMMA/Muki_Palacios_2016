...
var slider2 = $('#slider-pequeno');
var avanzar2 = $('#btn-avanzar-pequeno');
var retroceder2 = $('#btn-retroceder-pequeno');

//===========  INSERTANDO LA ULTIMA IMAGEN DEL SLIDER AL PRINCIPIO DEL RECORRIDO  ===========//
$('#slider-pequeno section:last').insertBefore('#slider-pequeno section:first');
...
function moverD2(){
	slider2.animate({marginLeft:'-'+200+'%'},700, function(){
		...
		$('#slider-pequeno section:first').insertAfter('#slider-pequeno section:last');
