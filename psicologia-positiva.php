	...
	<div class="contenido">
		...
		<div class="derecha-contenido">
			<div class="contenido-psicologia-positiva">
				...
				<h3>Orígenes</h3>
				<p><img class="img-origenes" src="img/mukip2.jpg"> La Psicología Positiva fue desarrollada por el Profesor Martin Seligman  en 1990 a raíz de que la psicología  tradicionalmente solo se había  dedicado a estudiar los aspectos negativos y patológicos del ser humano (ansiedad, estrés, depresión, etc), dejando de lado a menudo el estudio de aspectos más positivos del ser humano como, por ejemplo, la creatividad, la inteligencia emocional, el humor, la sabiduría, la felicidad, la resiliencia, etc. A raíz de esto, empiezan las investigaciones que terminan en la consolidación de una nueva corriente de la Psicología…una corriente que decidió mirar las cosas desde una nueva perspectiva, una perspectiva más optimista y como su nombre lo indica, más positiva.</p>
