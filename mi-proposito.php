				...
				<div class="proposito">
					...
					<div class="contenedor-texto-proposito">
						...
						<div id="texto-proposito2">
							<h4>MI PROPÓSITO</h4>
							<p>
							Estoy convencida de que venimos al mundo a servir, a ayudar, a hacer la diferencia en la vida de los demás. Mi trabajo, hoy, me permite hacerlo totalmente.<br><br>
							 ¿Qué puede ser más trascendente que llevar a cabo programas y dictar conferencias para no solo ser feliz en el trabajo sino en la vida?<br><br>
							...
							<strong>Gracias “REINVENTA MUJER” por existir </strong>y gracias a cada una de las mujeres que vivió conmigo este programa que marcó el inicio de mayor florecimiento en mi vida.
